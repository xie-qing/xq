...
public class RabbitMqConfig {
	...
	public SimpleRabbitListenerContainerFactory multiListenerContainer() {
		...
		factory.setConcurrentConsumers(env.getProperty("spring.rabbitmq.listener.listener.simple.concurrency", int.class));
		factory.setMaxConcurrentConsumers(env.getProperty("spring.rabbitmq.listener.listener.simple.max-concurrency", int.class));
